...
export default function AutomaticGatewaysPage() {
  ...
  const toggleGatewayStatus = (gatewayId: string) => {
    // Toggle status - replace with API call
    console.log(`Toggling status for gateway ${gatewayId}`);
  };
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div className="flex-1">
            <h1 className="text-xl sm:text-2xl font-bold text-gray-900 flex items-center">
              ...
              <span className="truncate">Automatic Gateways</span>
            </h1>
            <p className="text-xs sm:text-sm text-gray-600 mt-1">Configure automatic payment gateways.</p>
          </div>
          ...
          {filteredGateways.map((gateway) => (
            <div key={gateway.id} className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6">
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between items-center">
                  <span className="text-sm text-gray-600">Limits:</span>
