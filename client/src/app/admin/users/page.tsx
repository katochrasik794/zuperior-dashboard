...
export default function AdminUsersPage() {
  ...
  const users: User[] = [
    ...
    },
    {
      id: "4",
      srNo: 4,
      name: "Mitesh Rasaikar",
      email: "miteshysi@gmail.com",
      phone: "5657863686",
  ...
  const stats = [
    ...
    { label: "Banned Users", value: users.filter(u => u.status === "banned").length, icon: UserX, color: "bg-red-500" },
    { label: "KYC Verified", value: users.filter(u => u.kycStatus === "verified").length, icon: Shield, color: "bg-purple-600" },
  ];
      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div className="flex-1">
            ...
            <p className="text-xs sm:text-sm text-gray-600 mt-1">Manage and view all registered users.</p>
          </div>
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-3 sm:gap-4">
            <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4 flex-1">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <select className="flex-1 sm:flex-none px-2 sm:px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors text-xs sm:text-sm">
                  <option value="25">25</option>
                  <option value="50">50</option>
                  <option value="100">100</option>
                </select>
                <button className="flex-1 sm:flex-none px-3 sm:px-4 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition-colors text-xs sm:text-sm font-medium">
                  Apply
                </button>
              </div>
            </div>
            ...
            <div className="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
              <div>
                <p className="text-sm text-gray-700">
                  Showing <span className="font-medium">1-6</span> of <span className="font-medium">6</span>
                </p>
              </div>
              <div>
