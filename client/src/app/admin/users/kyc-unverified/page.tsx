...
export default function KycUnverifiedPage() {
  ...
  // Mock data - filtered for KYC unverified users only
  const users: User[] = [
    {
      id: "1",
      srNo: 1,
  ...
  const stats = [
    { label: "KYC Unverified", value: users.length, icon: FileX, color: "bg-red-500" },
    { label: "Need Documents", value: users.length, icon: Shield, color: "bg-orange-500" },
  ];
      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="text-sm text-gray-600 mt-1">Users who haven&apos;t completed KYC verification.</p>
          </div>
