...
export default function KycPendingPage() {
  ...
  // Mock data - filtered for KYC pending users only
  const users: User[] = [
    {
      id: "2",
      srNo: 1,
  ...
  const stats = [
    { label: "KYC Pending", value: users.length, icon: Clock, color: "bg-yellow-500" },
    { label: "Awaiting Review", value: users.length, icon: CheckCircle, color: "bg-blue-500" },
  ];
