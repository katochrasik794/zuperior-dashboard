...
import { Users, Search, Filter, MoreHorizontal, Clock, CheckCircle, Eye, Edit, Ban, Download, Plus } from "lucide-react";
...
export default function KycPendingPage() {
  ...
  // Pre-filter for KYC pending users only
  const kycFilter = "Pending";
  ...
  }, [dispatch, currentPage, pageSize, searchQuery, statusFilter, emailVerifiedFilter]);
  ...
  const handleExportUsers = async () => {
    ...
    try {
      ...
      console.log('Exporting KYC pending users...');
    } catch (error) {
  ...
  const stats = users.list ? [
    { label: "KYC Pending", value: users.list.length, icon: Clock, color: "bg-yellow-500" },
    { label: "Awaiting Review", value: users.list.length, icon: CheckCircle, color: "bg-blue-500" },
      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="text-sm text-gray-600 mt-1">Users with KYC verification pending review.</p>
          </div>
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-4 lg:space-y-0">
            <div className="flex flex-col sm:flex-row sm:items-center space-y-4 sm:space-y-0 sm:space-x-4">
              <div className="flex-1 sm:w-80">
                <SearchBar
                  placeholder="Search KYC pending users..."
