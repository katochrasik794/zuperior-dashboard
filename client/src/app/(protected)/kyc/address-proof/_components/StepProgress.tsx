...
// import addressIcon from "@/assets/kyc/address-icon.png"; // You'll need to add this icon
...
export default function StepProgress({ currentStep }: StepProgressProps) {
  const stepLabels = ["Personal Information", "Address Verification", "Review & Finish"];
